...
if __name__ == "__main__":
    ...
    # I/O arguments
    parser.add_argument('--input_dir', type=str, default='input/project/images', help='input data directory')
    parser.add_argument('--output_dir', type=str, default='input/project/inversion', help='output data directory')
    ...
    parser.add_argument('--learning_rate', type=float, default=0.75, help='Learning rate to use during optimization')
