...
if __name__ == "__main__":
    ...
    if args.clas is None:
        image_list = sorted(glob.glob(f"{args.input_dir}/*_{args.factor}x.jpg"))[30:100]
    else:
    ...
    for ref_im, ref_im_hr, ref_im_name in dataloader:
        ...
        if best_rec > args.eps:
            ...
            if args.duplicate == 1:
                torch.save(best_latent, f'input/project/resSR/test/wnf_{args.factor}_test/wnf_{image_id}')
            else:
            ...
            for i in range(args.batchsize):
                ...
                if args.clas is None:
                    img_name = f'{ref_im_name[i]}_F.jpg'
